...
A simple app based on a virtual pet in a hand held pocket device that you feed, clean, nurse when sick, play with, and make it sleep. It was a nice chance to practice what I know while learning Swift. For this exercise I was using optionals, properties,  designated and convenience initialisers, arrays, dictionaries. Code below:
